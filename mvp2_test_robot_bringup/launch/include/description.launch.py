...
def generate_launch_description():
    ...
    path_to_urdf = os.path.join( get_package_share_directory('mvp2_test_robot_description'), 'urdf', 'base.urdf' )
    rviz_config_dir = os.path.join( get_package_share_directory('mvp2_test_robot_description'), 'config', 'config.rviz' )
